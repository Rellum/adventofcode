...
```bash
curl -v --cookie "session=$ADVENT_OF_CODE_SESSION" https://adventofcode.com/2022/day/17/input > challenge-input.txt
elf --session=$ADVENT_OF_CODE_SESSION --year=2022 --day=17 | pbcopy
```
...
[Challenge-url]: https://adventofcode.com/2022/day/17
